...
import oleg.osipenko.mai.presentation.views.SubListContentView;
import rx.Subscriber;
import rx.observers.Subscribers;
import timber.log.Timber;

/**
 * Created by olegosipenko on 06.10.15.
 */
@Layout(R.layout.view_sublist_content)
@WithModule(SubListScreen.Module.class)
public class SubListScreen extends Path {
    String menuItem;

    public SubListScreen(String menuItem) {
        this.menuItem = menuItem;
    }

    @dagger.Module(
            injects = SubListContentView.class,
    ...
    @Singleton
    public static class Presenter extends MaiPresenter<SubListContentView, List<ListContent>> {
